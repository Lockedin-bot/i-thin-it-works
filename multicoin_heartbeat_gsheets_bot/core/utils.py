...
def load_settings() -> Settings:
    ...
    s.SPREADSHEET_ID = os.getenv("SPREADSHEET_ID", s.SPREADSHEET_ID)
    s.GOOGLE_SERVICE_ACCOUNT_JSON = os.getenv("GOOGLE_SERVICE_ACCOUNT_JSON", s.GOOGLE_SERVICE_ACCOUNT_JSON)
    return s
